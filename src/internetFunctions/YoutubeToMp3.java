...
public class YoutubeToMp3 {
	...
	public static void downloadSongs(int size) throws InterruptedException, ClassNotFoundException, SQLException, IOException {
		...
		String downloadDir = "C:\\College\\FreshmenSummer\\NuMusic\\WebContent\\musicSongs";
